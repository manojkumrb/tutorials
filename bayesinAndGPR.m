...
export_fig('2dParallelCond','-png','-r400','-transparent');
set(0,'currentfigure',bvnFig)
export_fig('2dNormaCond','-png','-r400','-transparent');
...
export_fig('6dParallelCond','-png','-r400','-transparent');
